...
namespace Hanafalah\ModuleSupport\Facades;
 ...
 */
class ModuleSupport extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleSupport\Contracts\ModuleSupport::class;
  }
}
